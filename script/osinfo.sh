...
echo -e "$hostname" 1> ./script/output/osresult
...
echo -e "$kernelinfo" 1>> ./script/output/osresult

kernelmac=`uname -m`
echo -e "  - HW Machine:      $kernelmac" 
echo -e "$kernelmac" 1>> ./script/output/osresult

CPU=`cat /proc/cpuinfo | grep "model name" | head -n 1 | awk -F ":" "{print $2}"`
echo -e "  - CPU info:        $CPU" 
echo -e "$CPU" 1>> ./script/output/osresult
...
echo -e "$network" 1>> ./script/output/osresult
...
echo -e "$externalip" 1>> ./script/output/osresult


Username=`whoami`
echo -e "  - UserName:        $Username" 
echo -e "$Username" 1>> ./script/output/osresult

echo -e "  - UserHomeDir:     $HOME\n" 
echo -e "$HOME" 1>> ./script/output/osresult
echo -e "\n---------------------------------------------------------------------------------------------\n"
...
echo -e "$report_MemTotal" 1>> ./script/output/osresult
echo -e "$report_MemFree" 1>> ./script/output/osresult
echo -e "$report_MemUsedPercent" 1>> ./script/output/osresult
...
echo -e "$report_DiskTotal" 1>> ./script/output/osresult
echo -e "$report_DiskFree" 1>> ./script/output/osresult
echo -e "$report_DiskUsedPercent" 1>> ./script/output/osresult
echo -e "$report_InodeTotal" 1>> ./script/output/osresult
echo -e "$report_InodeFree" 1>> ./script/output/osresult
echo -e "$report_InodeUsedPercent" 1>> ./script/output/osresult
